...
[Demo site](http://nberserk.github.io/)
...
```bash
$ git clone https://github.com/nberserk/hexo-theme-bootstrap.git themes/bootstrap
```
...
Modify the `theme` setting in `_config.yml` to `bootstrap`.
...
```yml
# File: themes/bootstrap/_config.yml
